package de.yannismate.webcrud.config;
...
@ComponentScans(value = {@ComponentScan("de.yannismate.webcrud.dao"),
    @ComponentScan("de.yannismate.webcrud.service")})
public class AppConfig {
  ...
  public LocalSessionFactoryBean getSessionFactory() {
    ...
    factoryBean.setPackagesToScan("de.yannismate.webcrud.model");
